...
saveToPDF("../../results_1MPI/both_sexes/MDS/MDS_raw_sex.pdf", width = 6, height = 6)
```
...
# save
path <- ("../../results_1MPI/both_sexes/JSD/JSD_raw")
...
write.table(lcpm_gene_names, "../../results_1MPI/both_sexes/counts/filtered_lcpm_gene_names.txt", sep= "\t", row.names = FALSE, quote=FALSE)
...
write.table(lcpm_gene_names, "../../results_1MPI/both_sexes/counts/filtered_cpm_gene_names.txt", sep= "\t", row.names = FALSE, quote=FALSE)
```
...
saveToPDF("../../results_1MPI/both_sexes/MDS/MDS_filtered_condition.pdf", width = 6, height = 6)
```
...
# save
path <- ("../../results_1MPI/both_sexes/library/gene_density")
...
path <- ("../../results_1MPI/both_sexes/library/lcpm_boxplots")
...
path <- paste0("../../results_1MPI/both_sexes/voom/voom_raw")
...
saveToPDF("../../results_1MPI/both_sexes/variance/variance_partition_violins.pdf", width = 8.5, height = 5)
...
write.table(variance_explained, "../../results_1MPI/both_sexes/variance/variance_explained.tsv",sep = "\t", quote = FALSE, row.names = FALSE)
```
...
plotCorrMatrix( C )
saveToPDF("../../results_1MPI/both_sexes/variance/CCA_with_project.pdf", width = 8, height = 8)
...
sumTable
write.table(sumTable, paste0("../../results_1MPI/both_sexes/DEGs/DEGs_summary_q", qval,"_log2FC", lfc.cutoff, ".txt"), quote = FALSE, sep = "\t")
...
pdf(paste0("../../results_1MPI/both_sexes/DEGs/DEGs_heatmap.pdf"), height = 6, width = 6)
...
for (i in allComparisons) {
  ...
  path <- paste0("../../results_1MPI/both_sexes/DEGs/", i, "_q1.00.txt", sep = "") 
  ...
  vTopTableSig <-
    topTable( 
      ...
      genelist = genes_relevant, 
      confint = TRUE)
  path <- paste0("../../results_1MPI/both_sexes/DEGs/", i, "_q", qval, "_lfc", lfc.cutoff,".txt", sep = "") 
...
ggplot(data = pcaWithMetadata, aes(x = PC1, y = PC2, shape = Group, color = Group)) +
  geom_point(size = 2.5) +
  theme_bw() 
saveToPDF("../../results_1MPI/both_sexes/PCA/PCA_dim1&2.pdf", width = 6, height = 5)

ggplot(data = pcaWithMetadata, aes(x = PC1, y = PC2, shape = Sex, color = Sex)) +
  geom_point(size = 2.5) +
  theme_bw() 
saveToPDF("../../results_1MPI/both_sexes/PCA/PCA_dim1&2_Sex.pdf", width = 6, height = 5)

ggplot(data = pcaWithMetadata, aes(x = PC2, y = PC3, shape = Group, color = Group)) +
  geom_point(size = 2.5) +
  theme_bw() 
saveToPDF("../../results_1MPI/both_sexes/PCA/PCA_dim2&3.pdf", width = 6, height = 5)

write.table(pcaWithMetadata, "../../results_1MPI/both_sexes/PCA/PCA_metadata.txt", quote = FALSE, sep = "\t")
```
...
for (i in allComparisons) {
  group1_vs_group2 <-
    read.delim(paste0("../../results_1MPI/both_sexes/DEGs/", i,"_q1.00.txt"))
    i <- gsub("_", " ", i)
    ...
    i <- gsub(" ", "_", i)
    pdf(paste0("../../results_1MPI/both_sexes/volcano/", i, ".pdf"), height = 6, width = 6)
    print(p)
    dev.off()
  } else {
  color_values <- vector()
  ...
  if (num != 0) {
    ...
    i <- gsub(" ", "_", i)
    # save
    path <-paste0("../../results_1MPI/both_sexes/volcano/",i)
    pdf(paste0(path, ".pdf"),
        height = 6,
        width = 6)
    print(p)
...
for (i in allComparisons) {
  filepath <- paste0("../../results_1MPI/both_sexes/DEGs/", i,"_q1.00.txt")
  assign(paste0(i),
...
write.xlsx(list_of_datasets, file = "../../results_1MPI/both_sexes/DEGs/DEGs.q1.00.xlsx")
```
