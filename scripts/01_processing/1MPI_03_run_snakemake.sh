#!/bin/bash
#SBATCH --job-name=1MPI_CB_processing                                                              
#SBATCH --time=10:00:00                               
#SBATCH --mem=2G
#SBATCH -n 4 # threaded 
#SBATCH --cpus-per-task=1
#SBATCH -o slurm.1MPI_CB_processing.job.%j.out
#SBATCH -e slurm.1MPI_CB_processing.job.%j.err
...
snakemake --nolock -s Snakefile_1MPI --jobs 16 --executor slurm --profile slurm_profile --rerun-incomplete --default-resources mem_mb=64000 ntasks=1 threads=1 runtime=550 cpus_per_task=8
