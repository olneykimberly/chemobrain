...
count_files <-
  file.path(paste0(
    "/tgen_labs/jfryer/cores/tgen/20250714_LH00295_0255_A23377MLT3/BAM/grandcanyon_results/",
    metadata$ID, "/rna/quant/star/", 
...
genes <- read.delim("/tgen_labs/jfryer/kolney/chemobrain/ensembl_mouse_protein_coding_genes.txt")
```
