...
design <- model.matrix( ~ 0 + info$Group_Sex)
...
Male_LEUC_vs_SALINE <- topTable(
  veBayesFit, 
  coef = "Male_LEUC_vs_SALINE",  
  n = Inf, 
  p.value = 1,
  lfc = 0, 
  sort.by = "P", 
