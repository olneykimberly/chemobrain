...
gtf.file <- paste0("/tgen_labs/jfryer/projects/references/mouse/Mus_musculus.GRCm39.112.gtf") #  refdata-gex-GRCm39-2024-A/genes/genes.gtf
...
write.table(
  genes,
  "/tgen_labs/jfryer/kolney/chemobrain/ensembl_mouse_genes_v112.txt",
  sep = "\t",
  row.names = FALSE,
  quote = FALSE
)
